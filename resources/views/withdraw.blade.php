...
<div class="container">
    ...
    <div class="withdraw" id="withdraw">
        ...
        <div class="current-balance">
            <p style="color: dodgerblue;font-size: 40px;line-height: 170px;">$10,000</p>
        </div>
        ...
        <div class="options">
            ...
            <div id="options">
                ...
                <a title="Withdraw with PayPal" onclick="openpp()"><img src="/assets/paypal.png" style="width: auto;height: 25px;margin-left: 30px;margin-top: 20px;"></a>
                <a title="Withdraw with EasyPaisa" onclick="openep()"><img src="/assets/easypaisa.png" style="width: auto;height: 40px;margin-left: 20px;margin-top: 15px;"></a>
