...
<div id="dialog" title="Contact form">
    ...
    <div class="landing">
        <video class="landing_video" autoplay loop muted playsinline>
    ...
    <div class="content_area">
        ...
        <div class="mission_sections">
            ...
            <div class="video">
                ...
                <a href="/videos" class="vid-btn">Start</a>
            </div>
            </div>
            ...
            <div class="app">
                ...
                <a href="/website" class="app-btn">Start</a>
            </div>
            </div>
            ...
            <div class="site">
                ...
                <a href="/app" class="site-btn">Start</a>
            </div>
            </div>
            ...
            <div class="verify">
                <p class="ver-link">Verify Your Account By Just Share The Link</p>
                <a href="/verify" class="ver-btn">Verify</a>
            </div>
            </div>
